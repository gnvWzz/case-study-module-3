...
<div class="container mt-lg-5">
  <div class="row">
    <div class="col-sm-6 col-xs-12">
      <img style="border: 1px black solid" src="${gear.image}" alt="" width="500px" height="500px">
    </div>
    <div class="col-sm-6 col-xs-12">
      <h1>${gear.name}</h1>
      <hr>
      <h5>Manufacturer: ${gear.manufacturer}</h5>
      <h5>Type: ${gear.type}</h5>
      <h5>Description: ${gear.description}</h5>
      <h5>Warranty: 24 months</h5>
      <hr>
      <h3 style="color: red">Price: ${gear.price} đ</h3>
      <br>
      <a href="${pageContext.request.contextPath}/addToCart?gearId=${gear.id}" class="btn btn-primary">Add To Cart</a>
    </div>
  </div>
</div>
